...
import com.example.anabi.finalyearproject1try.OtherChannelYoutube.adapters.CommentAdapter;
import com.example.anabi.finalyearproject1try.OtherChannelYoutube.models.YoutubeCommentModel;
...
public class OtherDetails extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_details); //activity_details
    ...
    private class RequestDownloadVideoStream extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(OtherDetails.this);
