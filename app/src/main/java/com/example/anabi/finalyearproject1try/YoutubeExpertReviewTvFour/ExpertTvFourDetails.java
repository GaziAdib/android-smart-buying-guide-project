...
//import com.example.anabi.finalyearproject1try.YoutubeSupport.adapters.CommentAdapter;
//import com.example.anabi.finalyearproject1try.YoutubeSupport.models.YoutubeCommentModel;
//import com.example.anabi.finalyearproject1try.YoutubeSupport.models.YoutubeDataModel;

import com.example.anabi.finalyearproject1try.YoutubeExpertReviewTvFour.adapters.CommentAdapter;
import com.example.anabi.finalyearproject1try.YoutubeExpertReviewTvFour.models.YoutubeDataModel;
import com.example.anabi.finalyearproject1try.YoutubeExpertReviewTvFour.models.YoutubeCommentModel;
...
public class ExpertTvFourDetails extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    private static final int READ_STORAGE_PERMISSION_REQUEST_CODE = 1;
    private static String GOOGLE_YOUTUBE_API = "AIzaSyDg3N5aGnNFIN2kbEOid0hD-y9Ov5HxR64";//here you should use your api key for testing purpose you can use this api also
    private YoutubeDataModel youtubeDataModel = null;
    TextView textViewName;
    TextView textViewDes;
    // ImageView imageViewIcon;
    public static final String VIDEO_ID = "90X9GHUm3Cw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expert_tv_one_details);
        ...
        new com.example.anabi.finalyearproject1try.YoutubeExpertReviewTvFour.ExpertTvFourDetails.RequestYoutubeCommentAPI().execute();
